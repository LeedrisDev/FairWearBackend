...
namespace BrandAndProductDatabase.API.Tests.Utils.HttpClientWrapper;
...
public class HttpClientWrapperTester
{
    ...
    public async Task GetAsync_WithGoogleUrl_ThenStatusCodeIsOK()
    {
        ...
        var httpClientWrapper = new API.Utils.HttpClientWrapper.HttpClientWrapper(_httpClientMock.Object);
