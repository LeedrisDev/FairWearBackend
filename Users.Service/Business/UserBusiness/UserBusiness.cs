...
public class UserBusiness : IUserBusiness
{
    ...
    /// <inheritdoc/>
    public Task<ProcessingStatusResponse<UserDto>> GetUserByIdAsync(long id)
    {
        return _userRepository.GetByIdAsync(id);
    }

    /// <inheritdoc/>
    public Task<ProcessingStatusResponse<UserDto>> CreateUserAsync(UserDto userDto)
    {
        return _userRepository.AddAsync(userDto);
    }
    ...
    /// <inheritdoc/>
    public Task<ProcessingStatusResponse<UserDto>> UpdateUserAsync(UserDto userDto)
    {
        return _userRepository.UpdateAsync(userDto);
    }

    /// <inheritdoc/>
    public Task<ProcessingStatusResponse<UserDto>> DeleteUserAsync(long id)
    {
