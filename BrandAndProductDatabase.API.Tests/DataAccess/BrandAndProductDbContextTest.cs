...
public class BrandAndProductDbContextTest : BrandAndProductDbContext
{
    public BrandAndProductDbContextTest(DbContextOptions<BrandAndProductDbContext> options) : base(options) { }
