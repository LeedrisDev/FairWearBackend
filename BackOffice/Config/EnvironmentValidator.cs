...
/// <summary>Utility class to validate required environment variables.</summary>
public abstract class EnvironmentValidator
{
    /// <summary>Validates the required environment variables.</summary>
    ...
    public static void ValidateRequiredVariables()
    {
        ...
        var varEnvDefined = IsVarEnvDefined("BRAND_AND_PRODUCT_DB_SERVICE_HOST");
    ...
    /// <summary>Checks if the specified environment variable is defined.</summary>
    ...
    /// <summary>Displays the begin validation message.</summary>
    ...
    /// <summary>Displays whether the variable is defined or not.</summary>
